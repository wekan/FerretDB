...
FerretDB releases use main-v1 and increment the v1 minor without rolling into v2.
Actions creates the prepared tag; missing builds stamp the requested version.
